...
class Generator():
    def __init__(self, width=64, height=64, max_rooms=10, min_room_xy=8,
                 max_room_xy=20, rooms_overlap=False, random_connections=1,
...
##        print('\nCorridor List: ', self.corridor_list)
        ...
        floor_array[location[1]]= change_char(floor_array[location[1]], location[0]-1, "P")
