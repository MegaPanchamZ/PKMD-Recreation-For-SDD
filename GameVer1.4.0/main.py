...
class Game:
    ...
    def load_data(self):
        ...
        self.map = TiledMap('ML', tileset)
        self.map_image = self.map.make_map()
        self.map_rect = self.map_image.get_rect()
        self.player_image = pg.image.load(Sprite_Folder + 'Sprite' +
                                          self.playerID + '/' +  'sprites.png').convert()

        self.spritesheet = SpriteSheet(Sprite_Folder + 'Sprite' +
